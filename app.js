        ...
        <div class="container">
            ...
            <div id="statistics-tab" class="tab-content">
                ...
                <div class="stats-section">
                    ...
                    <div class="stats-grid">
                        <div class="stat-card">
                            <div class="stat-number" id="total-cost">EGP 3,920</div>
                            <div class="stat-label">Total Spent</div>
                        </div>
                        <div class="stat-card">
                            <div class="stat-number" id="avg-cost">EGP 560</div>
                            <div class="stat-label">Average Cost</div>
                        </div>
                        <div class="stat-card">
                            <div class="stat-number" id="monthly-cost">EGP 672</div>
                            <div class="stat-label">Monthly Average</div>
                        </div>
                        <div class="stat-card">
                            <div class="stat-number" id="yearly-projection">EGP 8,064</div>
